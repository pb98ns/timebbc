...
delimiter //
create procedure sunday(IN user_id int(11), IN start_date date,  IN end_date date, IN type_vacation varchar(11))
...
WHILE (Counter <=TotalCount) DO
  ...
  if (DateValue != "2023-01-01" && DateValue != "2023-01-06" && DateValue != "2023-04-09" && DateValue != "2023-04-10" && DateValue != "2023-05-01" && DateValue != "2023-05-03" && DateValue != "2023-05-28" && DateValue != "2023-06-08" && DateValue != "2023-08-15" && DateValue != "2023-11-01" && DateValue != "2023-11-11" && DateValue != "2023-12-25" && DateValue != "2023-12-26" && DateValue != "2024-01-01" && DateValue != "2024-01-06" && DateValue != "2024-03-31" && DateValue != "2024-04-01" && DateValue != "2024-05-01" && DateValue != "2024-05-03" && DateValue != "2024-05-30" && DateValue != "2024-08-15" && DateValue != "2024-11-01" && DateValue != "2024-11-11" && DateValue != "2024-12-25" && DateValue != "2024-12-26") then
