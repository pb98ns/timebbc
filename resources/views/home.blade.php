...
<h3>
Czas pracy:
{{$projects->czas33 ? $projects->czas33 : '00:00:00'}}
</h3>
@endforeach
...
@csrf
    ...
    <div class="form-row d-flex flex-grow-1 justify-content-center align-items-center">
        ...
        <div class="form-group col-md-3 ">
            <label for="inputCity" class="form-row d-flex flex-grow-1 justify-content-center">Data</label>
<center>
            <input type="date" class="form-control justify-content-center"name="start_date" id="start_date">
</center>        
<br>
...
<input id="timeformatExample1" type="time" class="time form-control @error('time') is-invalid @enderror" name="time" role="button"value="{{ old('time') }}" required autocomplete="time" >
...
<div class="input-group-prepend">
  ...
  <input rows="1" class="form-control" style="webkit-border-radius: 5px; moz-border-radius: 5px; border-radius: 5px;" id="textarea" name="description" aria-label="With textarea" />
</div>
</div>  
